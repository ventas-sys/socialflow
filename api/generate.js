export default async function handler(req, res) {
  ...
  const tips = {
    ...
    wa: 'copy MUY corto para WhatsApp. Máximo 2 líneas. Incluir precio.',
    li: 'copy profesional para LinkedIn enfocado en valor. Entre 150 y 280 caracteres.',
    tw: 'copy conciso para Twitter/X con precio. Máximo 230 caracteres.'
  };
...
Genera UN copy de venta en español para ${platNames[platform]}.
Producto: ${info}
Requisito: ${tips[platform]}
Responde ÚNICAMENTE con el texto del copy listo para publicar. Sin comillas, sin explicaciones.`;
