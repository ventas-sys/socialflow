...
- **Reporte (solo PC, oculto en celular)**: hoy/7/30 días; por envío: **Zona FLEX** (cercana $4.490 / media $6.490 / lejana $8.690 / muylejana $9.990 — constantes ZONES en Shipments.jsx, actualizar cuando ML cambie) con **zona automática por coordenadas** (CABA_POLY: polígono aprox. de Capital = cercana; fuera: anillos desde el Obelisco ≤20km media, ≤38km lejana, más = muylejana; `effZone` = s.zone guardada pisa el cálculo, elegir en el select persiste) → Cobro ML auto; **Pago motoquero automático por zona** (`motoPay` en ZONES: cercana $2.750 — confirmado por el usuario 18/8; media/lejana/muylejana PENDIENTES de que pase los valores, mientras se cargan a mano y lo manual pisa lo automático) y **Pagó comprador** editable; totales + export Excel.
