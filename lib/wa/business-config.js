...
export const STORE = {
  ...
  // Si alguna vez ML cambia el formato, se corrige solo esta línea.
  searchUrl(keyword) {
    return `https://www.mercadolibre.com.ar/tienda/${this.slug}/search?q=${encodeURIComponent(keyword)}`;
  },
};
