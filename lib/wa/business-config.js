...
export const MAYORISTA = {
  driveUrl: 'https://drive.google.com/file/d/1Kow1z8RFvV9vXPo8nRwor8IepbivebWa/view?usp=sharing',
...
// --- Redes sociales (links completos, para promos y firmas) ---------------
export const REDES = {
  web: 'https://uniproveedores.com.ar',
  instagram: 'https://instagram.com/uniproveedoresok',
  youtube: 'https://youtube.com/@UNIPROVEEDORES',
  tiktok: 'https://tiktok.com/@uniproveedoresok',
  facebook: 'https://facebook.com/uniproveedores',
  x: 'https://x.com/uniproveedores',
};

// Bloque de redes listo para pegar en mensajes.
export const REDES_TEXTO =
...
export const RECORDATORIO = {
  ...
  mensaje:
    ...
    `Y si hacés un *video de 30 segundos* usando el producto para Instagram, te *triplicamos* el valor 🎬 ¡Podés ganar hasta *$15.000 en 1 minuto*! 🤑\n\n` +
    REDES_TEXTO,
};
