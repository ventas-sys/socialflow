...
- "reclamo_datos": el cliente YA está en un reclamo (según el historial) y manda su *usuario/apodo/nombre* de Mercado Libre (ej "Martin lu", "juanp_2024"), con o sin fotos previas. (El sistema confirma que un supervisor lo resuelve.) ⚠️ Excepciones dentro de un reclamo: si mandó un MAIL en vez del usuario → "answer" recordándole con onda que necesitás el apodo de ML (no el mail); si mandó SOLO una foto y todavía falta el usuario → "answer" agradeciendo la foto y pidiéndole el usuario.
