...
export function buildAnswerPrompt({ question, ctx, mode, cross, crossLocal, otro, catalogo, yaCompro, mayorista }) {
...
- Arrancá SIEMPRE con este saludo (según la hora): "¡Hola! ¿Cómo andás? ${saludoPorHora()}". Tratá de "vos".
...
- ${yaCompro
    ...
    : otroTxt}
- ${mayorista
    ? 'POR CANTIDAD / MAYOR: el cliente pregunta por varias unidades o por mayor. Además de darle el precio de la publicación, contale con onda que para esa CANTIDAD tenemos un MEJOR PRECIO POR MAYOR (con descuento). Invitalo a ver nuestras otras publicaciones y datos desde "Ver más datos de este vendedor" (en la publicación), o a escribirnos por acá para pasarle la info de mayorista. (No pidas mail ni teléfono, no vendas fuera de Mercado Libre.)'
    : ''}
