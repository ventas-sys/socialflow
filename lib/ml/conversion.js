...
export const ETIQUETAS = [
  { key: 'medidas', label: 'Medidas / tamaño',
    re: /\bmedid|\bmide\b|tama[nñ]o|dimension|\blargo\b|\bancho\b|\balto\b|\baltura\b|\bdi[aá]metro|\bespesor|cu[aá]nto pesa|\bpeso\b|\bkilos?\b|capacidad|\blitros?\b|pulgada|\bcm\b|\bmm\b|\bmts?\b|metros?/i },
  ...
  { key: 'retiro', label: 'Retiro por el local',
    re: /\bretir|\blocal\b|pasar a buscar|sucursal|d[oó]nde est[aá]|direcci[oó]n|ubicaci|\bzona\b|\bbarrio\b|paso a|puedo ir/i },
  { key: 'compatibilidad', label: 'Compatibilidad / uso',
    re: /sirve para|sirve pa|\bcompatible|anda en|funciona (con|en|para)|se puede usar|es apto|\bapto\b|\bpara qu[eé]\b/i },
  { key: 'material', label: 'Material / calidad',
    re: /\bmaterial|de qu[eé] est[aá] hecho|\bpl[aá]stico|\bmetal\b|\bacero|\bmadera|\bhierro|\bcalidad\b|resistente/i },
  ...
  { key: 'envio', label: 'Envío / demora',
    re: /\benv[ií]|\bllega\b|\bdemora|cu[aá]ndo llega|\bcorreo\b|\bflete\b|\bfull\b|despach/i },
  ...
  { key: 'otro_producto', label: 'Pregunta por otro artículo',
    re: /\botr[oa]s?\b|\baparte\b|\badem[aá]s\b|cat[aá]logo|lista de precio|\bvarios\b|consigu|m[aá]s productos/i },
];
